...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.save = exports.fetchItems = void 0;
...
var register_1 = __webpack_require__(/*! ../models/register */ "./src/models/register.ts");
...
var address_space_1 = __webpack_require__(/*! ../models/address-space */ "./src/models/address-space.ts");
var uuid_1 = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-node/index.js");
var projectActions_1 = __webpack_require__(/*! ../store/projectActions */ "./src/store/projectActions.ts");
var functionActions_1 = __webpack_require__(/*! ../store/functionActions */ "./src/store/functionActions.ts");
var fieldActions_1 = __webpack_require__(/*! ../store/fieldActions */ "./src/store/fieldActions.ts");
var fetchItems = function (data) {
    var project = new project_1.Project(uuid_1.v4(), data.project.name, data.project.path, data.project.addressUnitBits, data.project.name, data.project.vendor, data.project.description, data.project.version);
    store_1.store.dispatch(projectActions_1.addProject(project));
    data.funcs.forEach(function (func) {
        var fetchedFunc = new address_space_1.AddressSpace(func.id, func.name, func.baseAddress, func.size, func.width, func.description, '', '', [], []);
        var fetchedRegs = data.regs.filter(function (reg) { return reg.parentFuncId === fetchedFunc.id; });
        if (fetchedRegs != null) {
            fetchedRegs.forEach(function (reg) {
                var fetchedReg = new register_1.Register(reg.id, reg.parentFuncId, reg.name, reg.addressOffset, reg.access, reg.description, 0, 0, 0, 0, false, null, null, []);
                fetchedFunc.registers.push(fetchedReg.id);
                var fetchedFields = data.fields.filter(function (field) { return field.parentRegisterId === fetchedReg.id; });
                if (fetchedFields != null) {
                    fetchedFields.forEach(function (field) {
                        var fetchedField = new field_1.Field(field.id, field.parentRegisterId, field.name, 0, field.description, access_1.Access.Read, field.bitOffset + field.bitWidth - 1, field.bitOffset, []);
                        fetchedReg.fields.push(fetchedField.id);
                        store_1.store.dispatch(fieldActions_1.addField(fetchedField));
                    });
                }
                register_1.Register.add(fetchedReg);
            });
        }
        store_1.store.dispatch(functionActions_1.addFunction(fetchedFunc));
    });
    console.log(store_1.store.getState().projectReducer);
    return project;
};
exports.fetchItems = fetchItems;
var save = function () {
    var currentState = store_1.store.getState();
    var storeProjects = currentState.projectReducer.projects;
    var storeFuncs = currentState.functionReducer.addressSpaces;
    var storeBlocks = currentState.blockReducer.blocks;
    var storeRegs = currentState.registerReducer.registers;
    var storeFields = currentState.fieldReducer.fields;
    var storeEVS = currentState.enumeratedValueReducer.enumeratedValues;
    var data = {
...
var ipxact_helper_1 = __webpack_require__(/*! ./helpers/ipxact-helper */ "./src/helpers/ipxact-helper.ts");
...
var parse = function (options, write) {
    var cal = function () { return ipxact_helper_1.save(); };
    var opts = write ? { args: [cal()[0], cal()[1]] } : options;
    console.log("OPT", write, opts);
    python_shell_1.PythonShell.run('./src/python/parser.py', opts, function (err, results) {
        if (err)
            throw err;
        if (write == false) {
...
(function (Access) {
    ...
    Access[Access["ReadWriteOnce"] = 4] = "ReadWriteOnce";
    Access[Access["WriteOnce"] = 5] = "WriteOnce";
})(Access = exports.Access || (exports.Access = {}));


/***/ }),

/***/ "./src/models/address-space.ts":
/*!*************************************!*\
  !*** ./src/models/address-space.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var register_1 = __webpack_require__(/*! ./register */ "./src/models/register.ts");
var store_1 = __webpack_require__(/*! ../store/store */ "./src/store/store.ts");
var functionActions_1 = __webpack_require__(/*! ../store/functionActions */ "./src/store/functionActions.ts");
var AddressSpace = /** @class */ (function () {
    function AddressSpace(id, name, baseAddress, size, width, description, duplicateNb, duplicateId, registers, blocks) {
        this._id = id;
        this._name = name;
    ...
    Object.defineProperty(AddressSpace.prototype, "id", {
        /**
         * Getter id
         * @return {string}
         */
    ...
    Object.defineProperty(AddressSpace.prototype, "name", {
        /**
         * Getter name
         * @return {string}
         */
    ...
    Object.defineProperty(AddressSpace.prototype, "baseAddress", {
        /**
         * Getter baseAddress
         * @return {number}
         */
    ...
    Object.defineProperty(AddressSpace.prototype, "size", {
        /**
         * Getter size
         * @return {number}
         */
    ...
    Object.defineProperty(AddressSpace.prototype, "width", {
        /**
         * Getter width
         * @return {number}
         */
    ...
    Object.defineProperty(AddressSpace.prototype, "registers", {
        /**
         * Getter width
         * @return {Array<string>}
         */
    ...
    Object.defineProperty(AddressSpace.prototype, "blocks", {
        /**
         * Getter width
         * @return {Array<string>}
         */
    ...
    AddressSpace.deleteById = function (funcId) {
        var currentState = store_1.store.getState();
        var storeFuncs = currentState.functionReducer.addressSpaces;
        var func = storeFuncs.find(function (f) { return f.id === funcId; });
        console.log(func);
        if (func != null) {
            func.registers.forEach(function (regId) {
                register_1.Register.deleteById(regId);
            });
            //TODO remove blocks
            store_1.store.dispatch(functionActions_1.removeFunctions([func]));
        }
    };
    AddressSpace.deleteByIds = function (funcIds) {
        funcIds.forEach(function (funcId) {
            AddressSpace.deleteById(funcId);
        });
    };
    AddressSpace.add = function (func) {
        store_1.store.dispatch(functionActions_1.addFunction(func));
    };
    return AddressSpace;
}());
...
var Field = /** @class */ (function () {
    function Field(id, parentRegID, name, defaultValue, description, access, posh, posl, enumeratedValues) {
        this._id = id;
    ...
    Object.defineProperty(Field.prototype, "parentRegID", {
        /**
         * Getter id
         * @return {string}
         */
    ...
    Object.defineProperty(Field.prototype, "access", {
        /**
         * Getter access
         * @return {Access}
         */
    ...
    Object.defineProperty(Field.prototype, "posh", {
        /**
         * Getter posh
         * @return {number}
         */
    ...
    Object.defineProperty(Field.prototype, "posl", {
        /**
         * Getter posl
         * @return {number}
         */
    ...
    Object.defineProperty(Field.prototype, "enumeratedValues", {
        /**
...
var Project = /** @class */ (function () {
    function Project(id, fileName, filePath, addressBits, projectName, company, description, version) {
        this._projectID = id;
    ...
    Object.defineProperty(Project.prototype, "filePath", {
        /**
         * Getter filePath
         * @return {string}
         */
    ...
    Object.defineProperty(Project.prototype, "addressBits", {
        /**
     * Getter addressBits
     * @return {number}
     */
...
var fieldActions_1 = __webpack_require__(/*! ../store/fieldActions */ "./src/store/fieldActions.ts");
var evActions_1 = __webpack_require__(/*! ../store/evActions */ "./src/store/evActions.ts");
var functionActions_1 = __webpack_require__(/*! ../store/functionActions */ "./src/store/functionActions.ts");
var store_1 = __webpack_require__(/*! ../store/store */ "./src/store/store.ts");
var Register = /** @class */ (function () {
    function Register(id, parentFunctionId, name, address, access, description, defaultValue, mask, dim, dimOffset, isHidden, duplicateNb, duplicateId, fields) {
        this._id = id;
    ...
    Object.defineProperty(Register.prototype, "parentFunctionId", {
        /**
    ...
    Object.defineProperty(Register.prototype, "address", {
        /**
         * Getter address
         * @return {number}
         */
    ...
    Object.defineProperty(Register.prototype, "access", {
        /**
         * Getter access
         * @return {Access}
         */
    ...
    Object.defineProperty(Register.prototype, "description", {
        /**
         * Getter description
         * @return {string}
         */
    ...
    Object.defineProperty(Register.prototype, "defaultValue", {
        /**
         * Getter defaultValue
         * @return {number}
         */
    ...
    Object.defineProperty(Register.prototype, "mask", {
        /**
         * Getter mask
         * @return {number}
         */
    ...
    Object.defineProperty(Register.prototype, "dim", {
        /**
         * Getter dim
         * @return {number}
         */
    ...
    Object.defineProperty(Register.prototype, "dimOffset", {
        /**
         * Getter dimOffset
         * @return {number}
         */
    ...
    Object.defineProperty(Register.prototype, "isHidden", {
        /**
         * Getter isHidden
         * @return {boolean}
         */
    ...
    Object.defineProperty(Register.prototype, "fields", {
        /**
         * Getter width
         * @return {Array<string>}
         */
    ...
    Register.add = function (reg) {
        store_1.store.dispatch(registerActions_1.addRegister(reg));
    };
    Register.deleteById = function (regId) {
        var currentState = store_1.store.getState();
        var storeRegs = currentState.registerReducer.registers;
        var storeFuncs = currentState.functionReducer.addressSpaces;
        var storeFields = currentState.fieldReducer.fields;
        var storeEVS = currentState.enumeratedValueReducer.enumeratedValues;
        var reg = storeRegs.find(function (reg) { return reg.id === regId; });
        console.log(reg);
        if (reg != null) {
            var associatedFunc = storeFuncs.find(function (f) { return f.id === reg.parentFunctionId; });
            if (associatedFunc != null) {
                // detach from parent func
                associatedFunc.registers = associatedFunc.registers.filter(function (r) { return r !== reg.id; });
                store_1.store.dispatch(functionActions_1.updateFunction(associatedFunc));
                // clear the ev from fields
                if (reg.fields != null && reg.fields.length > 0) {
                    reg.fields.forEach(function (f) {
                        var field = storeFields.find(function (fi) { return f === fi.id; });
                        if (field != null) {
                            if (field.enumeratedValues != null && field.enumeratedValues.length > 0) {
                                var fetchedEV = storeEVS.find(function (ev) { return ev.parentFieldID === field.id; });
                                store_1.store.dispatch(evActions_1.removeEVS([fetchedEV]));
                            }
                            // delete child fields  
                            store_1.store.dispatch(fieldActions_1.removeFields([field]));
                        }
                    });
                }
            }
            ...
            reg.fields = [];
            store_1.store.dispatch(registerActions_1.removeRegisters([reg]));
        }
    };
    ...
    // Peace Sascha :)
    Register.deleteByIds = function (regIds) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RESET_APP = exports.REMOVE_PROJECT = exports.UPDATE_PROJECT = exports.ADD_PROJECT = exports.UPDATE_EV = exports.REMOVE_EVS = exports.ADD_EV = exports.UPDATE_FIELD = exports.REMOVE_FIELDS = exports.ADD_FIELD = exports.UPDATE_BLOCK = exports.REMOVE_BLOCKS = exports.ADD_BLOCK = exports.UPDATE_REGISTER = exports.REMOVE_REGISTERS = exports.ADD_REGISTER = exports.UPDATE_FUNCTION = exports.REMOVE_FUNCTIONS = exports.ADD_FUNCTION = void 0;
exports.ADD_FUNCTION = 'ADD_FUNCTION';
exports.REMOVE_FUNCTIONS = 'REMOVE_FUNCTIONS';
exports.UPDATE_FUNCTION = 'UPDATE_FUNCTION';
exports.ADD_REGISTER = 'ADD_REGISTER';
exports.REMOVE_REGISTERS = 'REMOVE_REGISTERS';
exports.UPDATE_REGISTER = 'UPDATE_REGISTER';
exports.ADD_BLOCK = 'ADD_BLOCK';
exports.REMOVE_BLOCKS = 'REMOVE_BLOCKS';
exports.UPDATE_BLOCK = 'UPDATE_BLOCK';
exports.ADD_FIELD = 'ADD_FIELD';
exports.REMOVE_FIELDS = 'REMOVE_FIELDS';
exports.UPDATE_FIELD = 'UPDATE_FIELD';
exports.ADD_EV = 'ADD_EV';
exports.REMOVE_EVS = 'REMOVE_EVS';
exports.UPDATE_EV = 'UPDATE_EV';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var actionTypes = __importStar(__webpack_require__(/*! ./actionTypes */ "./src/store/actionTypes.ts"));
var initialBlockState = {
    blocks: [],
};
var blockReducer = function (state, action) {
    if (state === void 0) { state = initialBlockState; }
    switch (action.type) {
        case actionTypes.ADD_BLOCK:
            if ('block' in action) {
                var newBlock = action.block;
                return __assign(__assign({}, state), { blocks: state.blocks.concat(newBlock) });
            }
        case actionTypes.UPDATE_BLOCK:
            if ('block' in action) {
                var updatedBlock_1 = action.block;
                var newState = state.blocks.map(function (bk) {
                    if (bk.id === updatedBlock_1.id) {
                        (bk.name = updatedBlock_1.name),
                            (bk.baseAddress = updatedBlock_1.baseAddress),
                            (bk.size = updatedBlock_1.size),
                            (bk.width = updatedBlock_1.width);
                        bk.parentFunc = updatedBlock_1.parentFunc;
                    }
                    return bk;
                });
                return __assign(__assign({}, state), { blocks: newState });
            }
        case actionTypes.REMOVE_BLOCKS:
            if ('blocks' in action) {
                var updatedBlocks = state.blocks.filter(function (bk) { return !action.blocks.includes(bk); });
                return __assign(__assign({}, state), { blocks: updatedBlocks });
            }
    }
    return state;
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeEVS = exports.updateEV = exports.addEV = void 0;
var actionTypes = __importStar(__webpack_require__(/*! ./actionTypes */ "./src/store/actionTypes.ts"));
var addEV = function (ev) {
    var action = {
...
exports.updateEV = updateEV;
var removeEVS = function (evs) {
    var action = {
...
exports.removeEVS = removeEVS;


/***/ }),

/***/ "./src/store/evReducer.ts":
/*!********************************!*\
  !*** ./src/store/evReducer.ts ***!
  \********************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var enumeratedValueReducer = function (state, action) {
    if (state === void 0) { state = initialEVState; }
    switch (action.type) {
        case actionTypes.ADD_EV:
            if ('ev' in action) {
                var newEV = action.ev;
                return __assign(__assign({}, state), { enumeratedValues: state.enumeratedValues.concat(newEV) });
            }
        case actionTypes.UPDATE_EV:
            if ('ev' in action) {
                var updatedEV_1 = action.ev;
                var newState = state.enumeratedValues.map(function (ev) {
                    if (ev.id === updatedEV_1.id) {
                        (ev.name = updatedEV_1.name),
                            (ev.parentFieldID = ev.parentFieldID),
                            (ev.value = updatedEV_1.value);
                    }
                    return ev;
                });
                return __assign(__assign({}, state), { enumeratedValues: newState });
            }
        case actionTypes.REMOVE_EVS:
            if ('evs' in action) {
                var updatedEVS = state.enumeratedValues.filter(function (ev) { return !action.evs.includes(ev); });
                return __assign(__assign({}, state), { enumeratedValues: updatedEVS });
            }
    }
    return state;
};
exports.default = enumeratedValueReducer;


/***/ }),

/***/ "./src/store/fieldActions.ts":
/*!***********************************!*\
  !*** ./src/store/fieldActions.ts ***!
  \***********************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeFields = exports.updateField = exports.addField = void 0;
var actionTypes = __importStar(__webpack_require__(/*! ./actionTypes */ "./src/store/actionTypes.ts"));
...
var fieldReducer = function (state, action) {
    ...
    switch (action.type) {
        case actionTypes.ADD_FIELD:
            if ('field' in action) {
                var newField = action.field;
                console.log(newField);
                return __assign(__assign({}, state), { fields: state.fields.concat(newField) });
            }
        case actionTypes.REMOVE_FIELDS:
            if ('fields' in action) {
                var updatedFields = state.fields.filter(function (f) { return !action.fields.includes(f); });
                return __assign(__assign({}, state), { fields: updatedFields });
            }
        case actionTypes.UPDATE_FIELD:
            if ('field' in action) {
                var updatedField_1 = action.field;
                var newState = state.fields.map(function (f) {
                    if (f.id === updatedField_1.id) {
                        (f.name = updatedField_1.name),
                            (f.defaultValue = updatedField_1.defaultValue),
                            (f.description = updatedField_1.description),
                            (f.access = updatedField_1.access),
                            (f.posh = updatedField_1.posh),
                            (f.posl = updatedField_1.posl);
                    }
                    return f;
                });
                return __assign(__assign({}, state), { fields: newState });
            }
    }
    return state;
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeFunctions = exports.updateRegisterInFunction = exports.updateFunction = exports.addFunction = void 0;
var actionTypes = __importStar(__webpack_require__(/*! ./actionTypes */ "./src/store/actionTypes.ts"));
var addFunction = function (addressSpace) {
    var action = {
...
var updateFunction = function (addressSpace) {
    var action = {
...
var updateRegisterInFunction = function (addressSpace) {
    var action = {
...
exports.updateRegisterInFunction = updateRegisterInFunction;
var removeFunctions = function (addressSpaces) {
    var action = {
        type: actionTypes.REMOVE_FUNCTIONS,
...
var functionReducer = function (state, action) {
    if (state === void 0) { state = initialAddressSpaceState; }
    switch (action.type) {
        case actionTypes.ADD_FUNCTION:
            if ('addressSpace' in action) {
                var newAddressSpace = action.addressSpace;
                return __assign(__assign({}, state), { addressSpaces: state.addressSpaces.concat(newAddressSpace) });
            }
        case actionTypes.UPDATE_FUNCTION:
            if ('addressSpace' in action) {
                var updatedAddressSpace_1 = action.addressSpace;
                console.log('ADDRESS ACTION', updatedAddressSpace_1);
                var newState = state.addressSpaces.map(function (func) {
                    if (func.id === updatedAddressSpace_1.id) {
                        (func.name = updatedAddressSpace_1.name),
                            (func.baseAddress = updatedAddressSpace_1.baseAddress),
                            (func.size = updatedAddressSpace_1.size),
                            (func.width = updatedAddressSpace_1.width);
                        (func.registers = updatedAddressSpace_1.registers);
                    }
                    return func;
                });
                return __assign(__assign({}, state), { addressSpaces: newState });
            }
        case actionTypes.REMOVE_FUNCTIONS:
            if ('addressSpaces' in action) {
                var updatedAddressSpaces = state.addressSpaces.filter(function (func) { return !action.addressSpaces.includes(func); });
                return __assign(__assign({}, state), { addressSpaces: updatedAddressSpaces });
            }
    }
    return state;
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeProject = exports.updateProject = exports.addProject = void 0;
var actionTypes = __importStar(__webpack_require__(/*! ./actionTypes */ "./src/store/actionTypes.ts"));
...
var projectReducer = function (state, action) {
    if (state === void 0) { state = initialProjectState; }
    switch (action.type) {
        case actionTypes.ADD_PROJECT:
            var newProjet = action.project;
            return __assign(__assign({}, state), { projects: state.projects.concat(newProjet) });
        case actionTypes.UPDATE_PROJECT:
            var updatedProject_1 = action.project;
            var newState = state.projects.map(function (pro) {
                if (pro.id === pro.id) {
                    (pro.fileName = updatedProject_1.fileName),
                        (pro.addressBits = updatedProject_1.addressBits),
                        (pro.projectName = updatedProject_1.projectName),
                        (pro.company = updatedProject_1.company);
                    pro.version = updatedProject_1.version;
                }
                return pro;
            });
            return __assign(__assign({}, state), { projects: newState });
        case actionTypes.REMOVE_PROJECT:
            var updatedProjects = state.projects.filter(function (pro) { return !action.project; });
            return __assign(__assign({}, state), { projects: updatedProjects });
    }
    return state;
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.removeRegisters = exports.updateRegister = exports.addRegister = void 0;
var actionTypes = __importStar(__webpack_require__(/*! ./actionTypes */ "./src/store/actionTypes.ts"));
var addRegister = function (register) {
    var action = {
...
var removeRegisters = function (registers) {
    var action = {
...
exports.removeRegisters = removeRegisters;


/***/ }),

/***/ "./src/store/registerReducer.ts":
/*!**************************************!*\
  !*** ./src/store/registerReducer.ts ***!
  \**************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var registerReducer = function (state, action) {
    if (state === void 0) { state = initialRegisterState; }
    switch (action.type) {
        case actionTypes.ADD_REGISTER:
            if ('register' in action) {
                var newRegister = action.register;
                return __assign(__assign({}, state), { registers: state.registers.concat(newRegister) });
            }
        case actionTypes.REMOVE_REGISTERS:
            if ('registers' in action) {
                var updatedRegisters = state.registers.filter(function (reg) { return !action.registers.includes(reg); });
                return __assign(__assign({}, state), { registers: updatedRegisters });
            }
        case actionTypes.UPDATE_REGISTER:
            if ('register' in action) {
                var updatedRegister_1 = action.register;
                console.log('ADDRESS ACTION', updatedRegister_1);
                var newState = state.registers.map(function (reg) {
                    if (reg.id === updatedRegister_1.id) {
                        (reg.name = updatedRegister_1.name),
                            (reg.address = updatedRegister_1.address),
                            (reg.dim = updatedRegister_1.dim),
                            (reg.dimOffset = updatedRegister_1.dimOffset),
                            (reg.parentFunctionId = updatedRegister_1.parentFunctionId),
                            (reg.description = updatedRegister_1.description),
                            (reg.mask = updatedRegister_1.mask),
                            (reg.isHidden = updatedRegister_1.isHidden),
                            (reg.defaultValue = updatedRegister_1.defaultValue),
                            (reg.access = updatedRegister_1.access);
                    }
                    return reg;
                });
                return __assign(__assign({}, state), { registers: newState });
            }
    }
    return state;
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.store = exports.ResetAppAction = void 0;
var redux_1 = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
var toolkit_1 = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");
var functionReducer_1 = __importDefault(__webpack_require__(/*! ./functionReducer */ "./src/store/functionReducer.ts"));
var blockReducer_1 = __importDefault(__webpack_require__(/*! ./blockReducer */ "./src/store/blockReducer.ts"));
var registerReducer_1 = __importDefault(__webpack_require__(/*! ./registerReducer */ "./src/store/registerReducer.ts"));
var fieldReducer_1 = __importDefault(__webpack_require__(/*! ./fieldReducer */ "./src/store/fieldReducer.ts"));
var evReducer_1 = __importDefault(__webpack_require__(/*! ./evReducer */ "./src/store/evReducer.ts"));
var projectReducer_1 = __importDefault(__webpack_require__(/*! ./projectReducer */ "./src/store/projectReducer.ts"));
var customizedMiddleware = toolkit_1.getDefaultMiddleware({
    serializableCheck: false
});
var appReducer = toolkit_1.combineReducers({
    functionReducer: functionReducer_1.default,
    registerReducer: registerReducer_1.default,
    blockReducer: blockReducer_1.default,
    fieldReducer: fieldReducer_1.default,
    enumeratedValueReducer: evReducer_1.default,
    projectReducer: projectReducer_1.default
});
exports.ResetAppAction = {
    type: "RESET_APP"
};
