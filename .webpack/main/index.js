...
var export_type_1 = __webpack_require__(/*! ./models/export-type */ "./src/models/export-type.ts");
// Handle creating/removing shortcuts on Windows when installing/uninstalling.
if (__webpack_require__(/*! electron-squirrel-startup */ "./node_modules/electron-squirrel-startup/index.js")) {
    electron_1.app.quit();
}
var isMac = process.platform === 'darwin';
var platformStr = isMac ? 'mac' : 'win32';
var globalParserPath = path_1.default.join(electron_1.app.getAppPath(), '.webpack/renderer', "static/decoder/" + platformStr + "/xactron_parser" + (!isMac ? '.exe' : ''));
...
var globalExportVHDLPath = path_1.default.join(electron_1.app.getAppPath(), 'src', "python/export_vhdl.py");
var globalExportExcelPath = path_1.default.join(electron_1.app.getAppPath(), 'src', "python/export_excel.py");
// const globalExportExcelPath = path.join(
//   app.getAppPath(),
//   '.webpack/renderer',
//   `static/exporters/${platformStr}/exportExcel${!isMac ? '.exe' : ''}`,
// );
var globalExportCPath = path_1.default.join(electron_1.app.getAppPath(), '.webpack/renderer', "static/exporters/" + platformStr + "/exportC" + (!isMac ? '.exe' : ''));
            ...
            submenu: [
                {
                    ...
                    click: function () {
                        electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-open-project', 'open');
                    },
                },
                {
                    label: 'Open Recent',
                ...
                },
                {
                    ...
                    click: function () {
                        electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-new-project', 'new');
                    },
                },
                {
                    ...
                    label: 'Edit Project',
                    click: function () {
                        electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-edit-project', 'edit');
                    },
                },
                {
                    type: 'separator',
                },
                {
                    ...
                    click: function () {
                        electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-save-project', 'save');
                    },
                },
                {
                    id: 'menu-save-as',
                    ...
                    click: function () {
                        electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-save-as', 'save');
                    },
                },
                {
                    id: 'menu-close',
                    ...
                    label: 'Close Project',
                    click: function () {
                        electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-close-project', 'close');
                    },
                },
                {
                    type: 'separator',
                },
                {
                    ...
                    submenu: [
                        ...
                        },
                        {
                            ...
                            click: function () {
                                electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-export-vhdl');
                            },
                        },
                        {
                            id: 'export-excel',
                            ...
                            click: function () {
                                electron_1.BrowserWindow.getFocusedWindow().webContents.send('mm-export-excel');
                            },
                        },
                        {
                            id: 'combine-excel',
...
electron_1.app.on('ready', function () {
    electron_1.session.defaultSession.protocol.registerFileProtocol('static', function (request, callback) {
        var fileUrl = request.url.replace('static://', '');
        var filePath = path_1.default.join(electron_1.app.getAppPath(), '.webpack/renderer', fileUrl);
        callback(filePath);
    ...
    electron_1.ipcMain.on('save-project', function (event, args) { return __awaiter(void 0, void 0, void 0, function () {
        var stringified, options;
        return __generator(this, function (_a) {
            console.log(args[0]);
            stringified = JSON.stringify(args[0]);
            options = {
    ...
    electron_1.ipcMain.on('save-as', function (event, args) { return __awaiter(void 0, void 0, void 0, function () {
        var stringified, options;
        return __generator(this, function (_a) {
            stringified = JSON.stringify(args[0]);
            options = {
    ...
    electron_1.ipcMain.on('export-VHDL', function (event, args) { return __awaiter(void 0, void 0, void 0, function () {
        var stringified, options;
        return __generator(this, function (_a) {
            stringified = JSON.stringify(args[0]);
            options = {
            ...
            handleExport(export_type_1.ExportType.VHDL, options);
            return [2 /*return*/];
        });
    }); });
    electron_1.ipcMain.on('export-Excel', function (event, args) { return __awaiter(void 0, void 0, void 0, function () {
        var stringified, options;
        return __generator(this, function (_a) {
            stringified = JSON.stringify(args[0]);
            options = {
            ...
            handleExport(export_type_1.ExportType.Excel, options);
            return [2 /*return*/];
        });
    }); });
    var parse = function (options, write) {
        try {
            ...
            execFile(globalParserPath, options.args, function (err, results) {
                console.log('PARSE OUT', results);
                if (err)
                    throw electron_1.BrowserWindow.getAllWindows()[0].webContents.send('parse-error', err.message);
                if (write == false) {
                    var strRes = results.toString();
                    try {
                        var data = JSON.parse(strRes);
                        console.log(data);
                        electron_1.BrowserWindow.getAllWindows()[0].webContents.send('add-parsed-items', data);
                    }
                    catch (error) {
                        electron_1.BrowserWindow.getAllWindows()[0].webContents.send('parse-error', error.message);
                    }
                }
            });
        }
        catch (err) {
            electron_1.BrowserWindow.getAllWindows()[0].webContents.send('parse-error', err.message);
        }
    };
    var handleExport = function (exportType, options) {
        switch (exportType) {
            case export_type_1.ExportType.C:
                // TODO Export C
                break;
            case export_type_1.ExportType.VHDL:
                var execFile = __webpack_require__(/*! child_process */ "child_process").execFile;
                python_shell_1.PythonShell.run(globalExportVHDLPath, options, function (err, results) {
            ...
            // });
            // break;
            case export_type_1.ExportType.Excel:
                python_shell_1.PythonShell.run(globalExportExcelPath, options, function (err, results) {
                    console.log('results: ', results);
                    if (err)
                        throw err;
                });
...
var verifyAccess = function (filePath) {
    var exec = __webpack_require__(/*! child_process */ "child_process").exec;
    if (isMac) {
        exec("chmod -R 777 " + filePath, function (err, results) {
            if (err)
                throw err;
            console.log(results);
        });
...
electron_1.app.on('open-file', function (event, path) {
    ...
    electron_1.BrowserWindow.getFocusedWindow().webContents.send('open-recent-file', path);
});


/***/ }),

/***/ "./src/models/export-type.ts":
/*!***********************************!*\
  !*** ./src/models/export-type.ts ***!
  \***********************************/
...
var ExportType;
(function (ExportType) {
    ExportType[ExportType["VHDL"] = 0] = "VHDL";
    ExportType[ExportType["Excel"] = 1] = "Excel";
    ExportType[ExportType["C"] = 2] = "C";
    ExportType[ExportType["Word"] = 3] = "Word";
